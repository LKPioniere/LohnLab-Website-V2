        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Die intelligente Nutzung gesetzlicher Möglichkeiten zur Kostenoptimierung bei Lohnerhöhungen
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Warengutscheine, Tankgutscheine bis 50€/Monat steuerfrei</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Calculator className="w-6 h-6 text-[var(--lohn-purple)] mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Fahrtkosten & Reisekosten</h4>
                    <p className="text-gray-600">Optimierte Abrechnung von Dienstreisen und Fahrtkosten</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Users className="w-6 h-6 text-[var(--lohn-purple)] mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Kindergartenkostenzuschüsse</h4>
                    <p className="text-gray-600">Steuerfreie Unterstützung für Kinderbetreuungskosten</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Shield className="w-6 h-6 text-[var(--lohn-purple)] mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Betriebliche Altersvorsorge</h4>
                    <p className="text-gray-600">Steuer- und sozialversicherungsfreie Altersvorsorge</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Die gesparten Lohnkosten bieten verschiedene strategische Möglichkeiten
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 text-center">
              ...
              <h3 className="text-xl font-bold text-blue-800 mb-3">Reinvestition</h3>
              <p className="text-blue-700">
                Gesparte Mittel zurück ins Unternehmen investieren für Wachstum und Entwicklung.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 text-center">
              ...
              <p className="text-purple-700">
                Attraktive Zusatzleistungen wie Jobtickets, Gesundheitsvorsorge oder Weiterbildung.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-gray-600">Automatische Optimierungsvorschläge</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                ...
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Maximale Ersparnisberechnung</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Verschiedene Verwendungsszenarien</span>
                </li>
              </ul>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="w-12 h-12 bg-[var(--lohn-secondary)] rounded-xl flex items-center justify-center mb-6">
                <FileCheck className="text-white text-lg" />
              </div>
              <h3 className="text-xl font-bold text-[var(--lohn-primary)] mb-4">Umsetzungsbegleitung</h3>
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Detaillierte Umsetzungspläne</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Vertragsvorlagen und Dokumentation</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Integration in bestehende Systeme</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Laufende Überwachung und Anpassung</span>
                </li>
              </ul>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <div className="w-12 h-12 bg-[var(--lohn-purple)] rounded-xl flex items-center justify-center mb-6">
                <Target className="text-white text-lg" />
              </div>
              <h3 className="text-xl font-bold text-[var(--lohn-primary)] mb-4">Betreuung & Support</h3>
              <ul className="space-y-3">
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Persönliche Beratung durch Experten</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Regelmäßige Optimierungsreviews</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
                  <span className="text-gray-600">Updates bei Gesetzesänderungen</span>
                </li>
                <li className="flex items-start space-x-3">
                  <CheckCircle className="text-green-600 mt-1 w-5 h-5" />
      ...
      <section className="py-20 bg-gradient-to-r from-[var(--lohn-purple)] to-[var(--lohn-primary)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Lassen Sie uns gemeinsam das Optimierungspotential Ihrer Lohnkosten analysieren.
          </p>
