import christopherImage from "@/assets/christopher-bausch.jpg";
import juliusImage from "@/assets/julius-henne.jpg";
import stephanImage from "@/assets/stephan-weppler.png";
...
export const REFERENCES: Reference[] = [
  ...
  },
  {
    ...
    quote: 'Durch LohnLab haben wir die Möglichkeit das Optimierungspotential jedes einzelnen Mitarbeiters zu verstehen und zu nutzen. Gehaltserhöhungen können mittels Massenberechnung für unsere komplette Belegschaft berechnet und einfach umgesetzt werden.',
    image: stephanImage,
    tags: ['Massenberechnung', 'Optimierungspotential', 'Komplette Belegschaft'],
    themeColor: 'emerald',
