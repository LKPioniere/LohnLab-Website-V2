        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="mb-8">
              ...
              natürliche Person beziehbar sind, z. B. ihr Name oder ihre
              IP-Adresse.
            </p>
            ...
            <p className="mb-4">
              ...
              (DSGVO) ist LohnLab GmbH, Hauptstraße 20, 63755 Alzenau,
              Deutschland, E-Mail:{" "}
              <ObfuscatedEmail
                user="service"
                domain="lohnlab.de"
            ...
            <p className="mb-4">
              ...
              Rechtsgrundlage für eine Datenverarbeitung kommen grundsätzlich
              die folgenden in Betracht:
            </p>
            <ul className="mb-8 list-disc list-inside space-y-2">
              <li>
                Art. 6 Abs. 1 S. 1 lit. a DSGVO dient uns als Rechtsgrundlage
                für Verarbeitungsvorgänge, für die wir eine Einwilligung
                einholen.
              </li>
              <li>
              ...
              <li>
                Art. 6 Abs. 1 S. 1 lit. c DSGVO findet Anwendung, wenn wir mit
                der Verarbeitung personenbezogener Daten eine rechtliche
                Verpflichtung erfüllen.
              </li>
              <li>
                Art. 6 Abs. 1 S. 1 lit. f DSGVO dient als Rechtsgrundlage, wenn
                wir uns zur Verarbeitung personenbezogener Daten auf berechtigte
            ...
            <p className="mb-8">
              Soweit wir Daten an Dienstleister oder sonstige Dritte außerhalb
              des EWR übermitteln, garantieren Angemessenheitsbeschlüsse der
              EU-Kommission nach Art. 45 Ab. 3 DSGVO die Sicherheit der Daten
            ...
            <p className="mb-4">
              Betroffene haben gegenüber uns folgende Rechte hinsichtlich der
            ...
            <p className="mb-8">
              ...
              Durchführung und Beendigung der Geschäftsbeziehung erforderlich
              sind.
            </p>
            ...
            <p className="mb-8">
              Zur Begründung und Durchführung einer Geschäftsbeziehung nutzen
            ...
            <p className="mb-8">
              ...
              werden die uns mitgeteilten Daten (z.B. Namen und E-Mail-Adressen)
              von uns gespeichert, um Fragen zu beantworten. Rechtsgrundlage für
              die Verarbeitung ist unser berechtigtes Interesse (Art. 6 Abs. 1
              S. 1 lit. f DSGVO).
            </p>
            ...
            <p className="mb-8">
              Wir behalten uns vor, Kunden, die bereits Dienstleistungen von uns
              in Anspruch genommen haben oder Waren gekauft haben, von Zeit zu
              Zeit per E-Mail über unsere Angebote zu informieren, falls sie dem
              nicht widersprochen haben. Rechtsgrundlage für diese
            ...
            <p className="mb-8">
              Unsere Website speichert Informationen in der Endeinrichtung von
              Websitebesuchern (z.B. Cookies) oder greift auf Informationen zu,
              die bereits in der Endeinrichtung gespeichert sind. Diese
              Speicherung erfolgt auf Grundlage der Einwilligung der
            ...
            <p className="mb-4">
              Bei der informatorischen Nutzung der Website erheben wir folgende
            ...
            <p className="mb-8">
              Unsere Website hostet Goneo. Anbieter ist goneo Internet GmbH,
              Dresdener Straße 18, 32423 Minden. Der Anbieter verarbeitet dabei
              die über die Website übermittelten personenbezogenen Daten in der
              EU. Weitere Informationen finden sich in der Datenschutzerklärung
              des Anbieters unter
              <a
            ...
            <p className="mb-8">
              ...
              Nachricht. Rechtsgrundlage für die Verarbeitung ist unser
              berechtigtes Interesse, an uns gerichtete Anfragen zu beantworten
