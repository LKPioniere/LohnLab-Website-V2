...
export default function FAQSection() {
  ...
  const faqs = [
    {
      ...
      answer: (
        <div>
          <p className="mb-3">
            Für alle Unternehmen ab ca. 10 {gendered ? "Mitarbeiter*innen" : "Mitarbeitern"}, die:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4">
            <li>steigende Personalkosten haben</li>
            <li>ihre Margen schützen wollen</li>
            <li>{gendered ? "Mitarbeiter*innen" : "Mitarbeiter"} binden möchten</li>
    ...
    },
    {
      ...
      answer: (
        <p>
          Klassische {gendered ? "Anbieter*innen" : "Anbieter"} verkaufen Einzellösungen oder Benefits.
          <br />
    ...
    {
      question: gendered ? "Kann ich mit meinem/meiner Steuerberater*in weiter zusammenarbeiten?" : "Kann ich mit meinem Steuerberater weiter zusammenarbeiten?",
      answer: (
        <p>
          Ja. Wir arbeiten eng mit {gendered ? "deinem/deiner Steuerberater*in" : "deinem Steuerberater"} / Lohnbüro zusammen und
  ...
  return (
    <section className="pt-20 md:pt-28 pb-[30rem] md:pb-[28rem] relative overflow-hidden bg-gray-100">
